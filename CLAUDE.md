...
| 4 | Provenance on every fact | Provenance FK on every user-facing table + render guard — data-architect Phase 1, frontend Phase 7 | Deferred (no schema yet) |
...
| 7 | PII never persists | Upload-cycle zero-PII test — parser-engineer, Phase 3 | Deferred (no intake yet) |
...
| 1 Data contracts | data-architect | Not started |
...
| 6 Design direction | design-director | Not started |
